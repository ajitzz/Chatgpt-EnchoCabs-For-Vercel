...
export default function TestimonialCarousel({
  ...
  return (
    <section
      ...
      className={`relative bg-gradient-to-b from-white to-white/70 py-20 ${className}`}
    >
          ...
          {track.map((t, i) => (
            ...
            >
              <article className="h-full rounded-2xl bg-white p-6 shadow-xl ring-1 ring-black/5">
                ...
                <p className="mb-1 font-semibold text-gray-900">{t.weekly}</p>
                ...
                <a href="#" className="mt-4 inline-block text-sky-600 underline decoration-sky-300 underline-offset-4 hover:text-sky-700">
                  Read more
                </a>
              </article>
            </li>
